// Página de gerenciamento de Tags de Cases
// CRUD completo para tags de cases
...
export default function CasesTags() {
  ...
  // Função para buscar tags do tipo case
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Tags de Cases</h1>
          <p className="text-muted-foreground mt-2">
            Organize seus cases com tags
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Ex: Crescimento, Inovação, etc."
              />
            </div>
          </div>
