      ...
      <main className="pt-32 pb-0">
        ...
        <section className="py-20 mb-20">
          <div className="container mx-auto px-12">
            <div className="grid lg:grid-cols-2 gap-8 mb-8">
              <div>
                <h2 className="text-3xl font-bold mb-4">É aqui que estruturamos, migramos e desenvolvemos soluções personalizadas para que seu e-commerce nasça forte e já pronto para escalar.</h2>
              </div>
              <div>
                <p className="leading-relaxed">Do planejamento estratégico à integração com marketplaces, conectamos todos os seus canais de venda para impulsionar o crescimento do seu negócio. Nossas soluções integram sistemas de gestão, logística e meios de pagamento, simplificando toda a operação e garantindo uma jornada de compra fluida e completa.</p>
              </div>
            </div>
            
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              {servicesList.map((service, index) => <div key={index} className="flex items-center gap-2 bg-primary-foreground/10 px-4 py-2 rounded-lg">
        ...
        <section className="mb-20">
          <div className="container mx-auto px-12">
            ...
            {services.map((service, index) => <div key={index} className="grid lg:grid-cols-[auto_1fr] gap-8 items-start">
