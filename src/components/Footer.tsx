          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="space-y-6 border-r border-white/10 pr-8">
              ...
              <div className="space-y-3">
                <a href="tel:+558399644-3602" className="flex items-center gap-3 text-white/70 hover:text-primary transition-colors text-sm">
                  <Phone className="w-4 h-4" />
                  <span>(83) 99644-3602</span>
                </a>

                <a href="mailto:contato@wayecommerce.com.br" className="flex items-center gap-3 text-white/70 hover:text-primary transition-colors text-sm">
              ...
              <div className="flex gap-3 pt-2">
                <a href="https://www.instagram.com/wayecommerce/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white hover:text-primary hover:bg-primary/20 transition-colors">
                  <Instagram className="w-4 h-4" />
                </a>
                <a href="https://www.linkedin.com/company/wayecommerce/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white hover:text-primary hover:bg-primary/20 transition-colors">
                  <Linkedin className="w-4 h-4" />
                </a>
                <a href="https://share.google/AaJY99hxuyzkT8BZi" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white hover:text-primary hover:bg-primary/20 transition-colors">
