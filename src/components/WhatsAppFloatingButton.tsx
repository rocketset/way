  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {/* Button container */}
        <div className="relative w-14 h-14 bg-gradient-to-br from-[#25D366] to-[#128C7E] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 group-hover:from-[#20BA5C] group-hover:to-[#0D7A6E]">
          {/* WhatsApp Icon */}
          <svg 
